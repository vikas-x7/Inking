  ...
  return (
    <section id="hero" className="relative w-full text-white bg-black overflow-hidden font-sans">
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1707380657552-25fbec5e2b1a?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt=""
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 pt-40 pb-20">
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center text-start md:text-center">
          ...
          <p className="text-[#e5e5e5] text-base sm:text-lg md:text-[15px]  max-w-3xl mt-5 md:font-semibold tracking-[0.3px]">
