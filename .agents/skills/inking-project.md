...
- `apps/server/.env`: NODE_ENV, API_URL, FRONTEND_URL, ACCESS_JWT_SECRET, REFRESH_JWT_SECRET, GOOGLE_CLIENT_ID/SECRET, GITHUB_CLIENT_ID/SECRET, LATEX_COMPILER_URL, COMPILER_INTERNAL_TOKEN
